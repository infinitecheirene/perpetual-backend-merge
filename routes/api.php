...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // JuanTap CRUD endpoints
    Route::prefix('juantap')->group(function () {
        Route::get('/profile', [JuanTapController::class, 'show']);
        Route::post('/profile', [JuanTapController::class, 'store']);
        Route::put('/profile', [JuanTapController::class, 'update']);
        Route::delete('/profile', [JuanTapController::class, 'destroy']);
    });
});
=======
